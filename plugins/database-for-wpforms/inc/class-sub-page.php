...
class WPFormsDB_Wp_Sub_Page
{
    ...
    public function list_table_page()
    {
        ...
        <div class="wrap">
            ...
            <h2>kh
                <?php echo get_the_title($this->form_post_id); ?>
            </h2>
    ...
    public function process_bulk_action()
    {
        ...
        if ('delete' === $action) {
            ...
            foreach ($form_ids as $form_id):
                ...
                $WPFormsDB_dirname = $upload_dir['basedir'] . '/WPFormsDB_uploads'; foreach ($result_values as $key => $result) {

                    if (
                        (strpos($key, 'WPFormsDB_file') !== false) &&
